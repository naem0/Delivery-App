                ...
                <Card className="shadow-xl relative overflow-hidden group">
                    ...
                    <CardContent className="p-6">
                        ...
                        <div className="flex flex-col md:flex-row gap-3">
                            <Textarea className="flex-1 bg-secondary/50 rounded-2xl p-4 text-sm min-h-[100px] resize-none border-border focus-visible:ring-primary cursor-pointer" placeholder={t.customOrderPlaceholder} onClick={onCustomOrderClick} readOnly />
                            <Button onClick={onCustomOrderClick} className="bg-primary hover:bg-red-600 text-white font-bold py-4 px-8 rounded-2xl shadow-lg text-base" size="lg">
